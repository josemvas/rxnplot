...
[rxnlvl](https://github.com/eutactic/rxnlvl) pero funciona nativamente en documentos de Jupyter. Para usarlo necesitas clonar o descargar `irxnlvl` y tener instalado JupyterLab con Python 3 o puedes [probar irxnvl en Binder](https://mybinder.org/v2/gh/qcuaeh/irxnlvl.git/HEAD) sin necesidad de instalar nada en tu computadora.
