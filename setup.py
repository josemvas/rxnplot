...
from os import path, remove, environ, listdir, getpid
from shutil import rmtree
from getpass import getuser

here = path.abspath(path.dirname(__file__))
with open(path.join(here, str(getpid()) + '_setup.log'), 'w') as f:
    f.write(repr(argv))
with open(path.join(here, str(getpid()) + '_environ.log'), 'w') as f:
